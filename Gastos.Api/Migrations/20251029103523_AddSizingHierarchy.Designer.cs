...
namespace Gastos.Api.Migrations
{
    ...
    [Migration("20251029103523_AddSizingHierarchy")]
    partial class AddSizingHierarchy
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gastos.Api.Features.Products.Product", b =>
                {
                    ...
                    b.HasIndex("UserId", "Name", "UnitsPack", "SizingId", "SizingValue")
                        .IsUnique()
                        .HasDatabaseName("ix_products_user_id_name_units_pack_sizing_id_sizing_value");
            ...
            modelBuilder.Entity("Gastos.Api.Features.Sizings.Sizing", b =>
                {
                    ...
                    b.HasIndex("ParentId")
                        .HasDatabaseName("ix_sizings_parent_id");
            ...
            modelBuilder.Entity("Gastos.Api.Features.Sizings.Sizing", b =>
                {
                    b.HasOne("Gastos.Api.Features.Sizings.Sizing", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_sizings_sizings_parent_id");
